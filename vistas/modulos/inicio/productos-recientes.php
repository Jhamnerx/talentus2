...
$productos = ControladorServicios::ctrMostrarTotalProductos("fecha");
...
<div class="box box-primary">
   ...
   <!-- box-header -->
	    	...
	    	for($i = 0; $i < 5; $i++){
	    		...
	    		echo '<li class="item">
				        ...
				        <div class="product-info">
				          <a href="" class="product-title">'.$productos[$i]["nombre"];
  	...
  	<div class="box-footer text-center">
    	...
    	<a href="servicios" class="uppercase">Ver todos los productos</a>
